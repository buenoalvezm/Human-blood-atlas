...
data_summarised |> 
  filter(Assay == "FGF21") |> 
  ggplot(aes(Disease, mean)) +
  geom_point() +
  geom_point(aes(y = median), color = "red") +
  geom_point(aes(y = Q1), color = "grey") +
  geom_point(aes(y = Q3), color = "grey") +
  theme_hpa(angled = T)

write_excel_csv(data_summarised, savepath_data("Supplementary-files", "Data_S12.csv"))
 ```
